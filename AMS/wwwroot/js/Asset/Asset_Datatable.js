$(document).ready(function () {
    ...
    $("#tblAsset").DataTable({
        ...
        "columns": [
            ...
            //            return "<a href='#' class='fa fa-user' onclick=AssignEmployeeInfo('" + row.AssignEmployeeId + "');> " + row.AssignEmployeeDisplay + "</a>";
            //        else
            //            return "<a href='#' onclick=UnassignedAssetWarning('" + row.AssignEmployeeId + "');> " + row.AssignEmployeeDisplay + "</a>";
            //    }
            //},
            ...
            {
                data: null, render: function (data, type, row) {
                    return "<a href='#' class='fa fa-plus-square' onclick=UpdateAssignee('" + row.Id + "');>Allocate</a>";
                }
            },
            {
                data: null, render: function (data, type, row) {
